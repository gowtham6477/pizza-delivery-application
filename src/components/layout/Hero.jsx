  ...
  return (
    <section className="hero mt-4">
      <div className="py-12">
        ...
        <p className="my-6 text-gray-500 text-sm">Experience the perfect fusion of Indian traditions and Italian flavors at Pizza world, where every slice delights</p>
